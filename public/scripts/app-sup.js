...
angular
  ...
  .config(['$stateProvider','$urlRouterProvider','$ocLazyLoadProvider',function ($stateProvider,$urlRouterProvider,$ocLazyLoadProvider) {
    ...
    $stateProvider
        ...
        resolve: {
            loadMyDirectives:function($ocLazyLoad){
                return $ocLazyLoad.load(
                {
                    ...
                    'scripts/directives/sidebar/sidebar-sup.js',
      ...
      .state('reportes.liquidaciones',{
        url:'/liquidaciones',
        templateUrl:'interior/liquidaciones/',
        controller:'liquidacionesController'
      })
      .state('reportes.liquidaciones2',{
        url:'/liquidaciones2',
        templateUrl:'interior/liquidaciones/',
        controller:'liquidacionesController'
      })
