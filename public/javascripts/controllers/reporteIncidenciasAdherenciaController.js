reportMedias.controller('reporteIncidenciaAdherenciaController',function($scope, $http,$cookies,$location,Notification,Title){
	$scope.tablaURL = "interior/reporte_incidencia_adherencia/tabla.html";
	$scope.filtroURL = "interior/reporte_incidencia_adherencia/filtro.html";
	$scope.ok = ($cookies.nivel==9 || $cookies.nivel==27) ? true : false;
	$scope.loading =false;
	$scope.guardando = false;
	$scope.listIncidencia = false;
	$scope.formPath = {};
	$scope.formFiltro = {};
