(function () {
  ...
  function createChart (type, scope, elem) {
    ...
    if (ctx.canvas['offsetHeight'] == 0){
          console.log("offsetHeight",ctx.canvas['offsetHeight']);
          console.log("no lo creo",ctx.canvas);
          return;
    }
  ...
  function getColours (scope) {
    if(typeof(scope.colours) != "undefined"){
      var colours = angular.copy(scope.colours) || ['#97BBCD', // blue
        '#DCDCDC', // light grey
        '#F7464A', // red
        '#46BFBD', // green
        '#FDB45C', // yellow
